...
data class HighlightConfig(
    ...
    companion object {
        ...
        fun highQuality() = HighlightConfig(
            maxHighlights = 15,
        ...
        fun audioFocused() = HighlightConfig(
            maxHighlights = 10,
        ...
        fun motionFocused() = HighlightConfig(
            maxHighlights = 12,
            minHighlightScore = 0.35f,
            motionWeight = 0.6f,
            audioWeight = 0.0f,
        ...
        fun peopleFocused() = HighlightConfig(
            maxHighlights = 10,
            minHighlightScore = 0.35f,
            faceWeight = 0.5f,
            motionWeight = 0.2f,
        ...
        fun sceneFocused() = HighlightConfig(
            maxHighlights = 12,
            minHighlightScore = 0.35f,
            visualWeight = 0.5f,
            motionWeight = 0.2f,
        ...
        fun shortVideo() = HighlightConfig(
            maxHighlights = 3,
            minHighlightScore = 0.3f,
