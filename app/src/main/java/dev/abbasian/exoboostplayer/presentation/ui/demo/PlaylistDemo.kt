...
fun PlaylistDemo(onBack: () -> Unit) {
    val playlist = remember {
        listOf(
            ...
            Track("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3", "Song 2", "SoundHelix"),
            Track("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3", "Song 3", "SoundHelix")
        )
    }
