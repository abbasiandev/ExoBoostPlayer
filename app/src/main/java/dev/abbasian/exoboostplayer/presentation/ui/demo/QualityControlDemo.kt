...
fun QualityControlDemo(url: String, onBack: () -> Unit) {
    ...
    LaunchedEffect(uiState.mediaInfo.currentQuality) {
        ...
        if (currentQuality != null && currentQuality != previousQuality) {
            qualityChanges = qualityChanges + QualityChangeEvent(
    ...
    Card(
        ...
        Column(
            ...
            InfoCard(
                ...
                description = "ExoBoost automatically reduces video quality when network errors occur," +
...
@Composable
private fun CurrentQualityCard(quality: VideoQuality?, mediaState: MediaState) {
...
@Composable
private fun QualityChip(quality: VideoQuality, isActive: Boolean) {
    Surface(
...
private fun QualityChangeItem(change: QualityChangeEvent) {
    Row(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Column {
                Text(
                    text = if (change.fromQuality != null) {
